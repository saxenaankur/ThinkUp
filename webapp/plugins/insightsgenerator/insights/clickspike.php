            ...
            foreach ($post->links as $link) {
                ...
                if ($click_count > 0 ) {
                    ...
                    && $click_count >= $high_click_count_365_days->value) {
                        ...
                        $simplified_post_date, "New 365-day record!", $click_count.
                        " people clicked your link.", $filename, Insight::EMPHASIS_HIGH,
                    ...
                    && $click_count >= $high_click_count_30_days->value) {
                        ...
                        $simplified_post_date, "New 30-day record!", $click_count.
                        " people clicked your link.", $filename, Insight::EMPHASIS_HIGH,
                        serialize(array($link, $click_stats_data)));
                    ...
                    && $click_count >= $high_click_count_7_days->value) {
                        ...
                        $simplified_post_date, "New 7-day record!", $click_count.
                        " people clicked your link.", $filename, Insight::EMPHASIS_HIGH,
                        serialize(array($link, $click_stats_data)));
                    ...
                    && $click_count > ($average_click_count_30_days->value*2)) {
                        ...
                        $simplified_post_date, "Amplified:", $click_count.
                        " people clicked your link, more than ".$multiplier. "x your 30-day average.", $filename,
                    ...
                    && $click_count > ($average_click_count_7_days->value*2)) {
                        ...
                        $simplified_post_date, "Amplified:", $click_count.
                        " people clicked your link, more than " .$multiplier. "x your 7-day average.",
    ...
    private function generateInsightBaselines($instance, $number_days=3) {
        ...
        while ($days_ago < $number_days) {
            ...
            if ($shortlink_dao->doesHaveClicksSinceDate($instance, 30, $since_date)) {
                ...
                $high_click_count_30_days = $shortlink_dao->getHighestClickCount($instance, 7, $since_date);
            ...
            if ($shortlink_dao->doesHaveClicksSinceDate($instance, 365, $since_date)) {
                ...
                $high_click_count_365_days = $shortlink_dao->getHighestClickCount($instance, 7, $since_date);
